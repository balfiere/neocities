...
[Spoken World Thai](https://libgen.is/book/index.php?md5=1A8DF192174153E1EF7BA8A3574CB188){target='_blank'}
: teaches basic vocabulary and grammar over the course of 15 lessons. i recommend being able to read thai before starting this book, although there are romanizations. comes with culture notes, reading and dialogue practice, and comprehension questions. i've uploaded the audio [here](https://drive.google.com/drive/folders/1aZRypqG6NCRfQ5hlZp-JJurkHa6tJCgz?usp=sharing){target='_blank'}.

[Complete Thai](https://archive.org/details/completethai0000smyt/mode/2up){target='_blank'}
: teaches basic vocabulary and grammar over the course of 17 lessons. the above link goes to an archive.org copy where you can 'check out' the whole book for an hour at a time. the audio for this book can be found [here](https://library.teachyourself.com/id004325066){target='_blank'} for free; an anki deck for this book can be found [here](https://ankiweb.net/shared/info/1713273983){target='_blank'}.

[Mango Languages](https://mangolanguages.com/find-mango/){target='_blank'}
...
[Learn Thai with Bo](https://www.youtube.com/@IwanttolearnTHAI){target='_blank'}
...
[Riam Thai](https://www.youtube.com/channel/UCGR50tSrFSxLkdDtdoSHRqA){target='_blank'}
...
[Understand Thai](https://www.youtube.com/channel/UC2AUUW5PhMf5Sji5RWopVCw){target='_blank'}
...
[Operation Language Stories](https://docs.google.com/document/d/17Xg7NW-XLPh1k8zAkajKO-FKzcStfb2p4Dww-mGPWDU/edit){target='_blank'}
...
[Thai Stories for Language Learners](https://drive.google.com/drive/folders/105jT8qpoq8KVwPkICQxQeokYD0gLv33L?usp=sharing){target='_blank'}
...
[Language Crush: Thai Conversations](https://languagecrush.com/reading/course/420){target='_blank'}
: 100 ~7 minute conversations between two native speakers on a variety of topics. comes with audio and transcript. the website is free but some features are restricted if you don't pay. i don't really like the interface anyways so i downloaded them all as .txt and .mp3, which you can access [here](https://drive.google.com/drive/folders/1mmBUbsFa_L1QU8SlOXOl5EeGgUIsE_X3?usp=sharing){target='_blank'}.

[Aakanee: SEA Illustrations](https://web.archive.org/web/20230608222558/http://www.aakanee.com/thai-illustrations.html){target='_blank'}
: around 40 15-20 minute monologues of thai speakers describing daily activities based on a given picture. comes with audio and transcript. you can also watch them as videos [here](https://www.youtube.com/playlist?list=PLOKPImLWvaffrJv9V5cumhj76EN7jjWok){target='_blank'}, but they do not have subtitles.
...
[lingopolo](https://lingopolo.org/thai/){target='_blank'}
...
[thai-notes](https://thai-notes.com/index.html){target='_blank'}
...
[Thai OCR with TrOCR](https://huggingface.co/spaces/phoner45/thai-ocr-img){target='_blank'}
: a huggingface space that uses the [ThaiTrOCR model](https://huggingface.co/openthaigpt/thai-trocr){target='_blank'} to convert images of thai to text. works best with one line of text per image but works better on handwritten text and stylized fonts compared to other models i've tried.
