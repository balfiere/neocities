...
[Open PS2 Loader](https://github.com/ps2homebrew/Open-PS2-Loader){target='_blank'}
: homebrew application that lets you play ps2 games on your ps2 without a disc. there are a number of different devices you can put your games on and play from, some of which are discussed [here](https://consolemods.org/wiki/PS2:Playing_Game_Backups){target='_blank'}. a game compatibility list can be found [here](https://www.ps2-home.com/forum/page/opl-game-compatibility-list-1){target='_blank'}. i recommend using the latest beta version which you can get [here](https://github.com/ps2homebrew/Open-PS2-Loader/releases/tag/latest){target='_blank'} (you want the one that starts with OPNPS2LD-V.1.2.0-Beta-xxxx), a simple guide to updating OPL can be found [here](https://www.reddit.com/r/ps2homebrew/comments/17huohs/need_help_updating_opl/){target='_blank'}.
...
[PCSX2 HD Texture Packs](https://gbatemp.net/forums/pcsx2-hd-texture-pack-group.549/){target='_blank'}
: links to hd texture pack mods of ps2 games, compatible with pcsx2. you can find a tutorial on how to use them [here](https://www.mksecrets.net/forums/eng/viewtopic.php?t=48376){target='_blank'}.
